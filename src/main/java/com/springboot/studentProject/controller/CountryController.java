...
import com.springboot.studentProject.service.CountryService;
...
public class CountryController {
	...
	@PostMapping("/create")
	public ResponseEntity<Country> saveCountries() {
	
		String[] countryList= {"Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla","Antigua &amp; Barbuda",
		...
		country.setCountryName(countryList[i]);
